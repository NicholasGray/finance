...
(function(factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/InventoryItem', 'model/Login', 'model/Manufacturer', 'api/AdminsApi', 'api/DevelopersApi'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('./ApiClient'), require('./model/InventoryItem'), require('./model/Login'), require('./model/Manufacturer'), require('./api/AdminsApi'), require('./api/DevelopersApi'));
  }
}(function(ApiClient, InventoryItem, Login, Manufacturer, AdminsApi, DevelopersApi) {
  'use strict';
