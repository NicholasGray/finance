...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/InventoryItem', 'model/Login'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/InventoryItem'), require('../model/Login'));
  } else {
    // Browser globals (root is window)
    if (!root.SimpleInventoryApi) {
      root.SimpleInventoryApi = {};
    }
    root.SimpleInventoryApi.DevelopersApi = factory(root.SimpleInventoryApi.ApiClient, root.SimpleInventoryApi.InventoryItem, root.SimpleInventoryApi.Login);
  }
}(this, function(ApiClient, InventoryItem, Login) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:api/DevelopersApi~searchUserCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Number} opts.skip number of records to skip for pagination
     * @param {Number} opts.limit maximum number of records to return
     * @param {module:api/DevelopersApi~searchUserCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/Login>}
     */
